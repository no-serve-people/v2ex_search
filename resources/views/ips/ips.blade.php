                ...
                @foreach($links as $link)
                    <tr id="tr_{{ $link->id }}" >
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick="getId({{ $link->id }})" class="btn btn-danger btn-sm btn-icon icon-left" >
                                删除
                            </a>
                        </td>
                    </tr>
