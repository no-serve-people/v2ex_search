        ...
        <h2 title="{{ $site_title or 'title' }}" style="margin: 0;">
            ...
            <a aria-hidden="true" href="">
                <img class="img-circle"
                     ...
                     alt="{{ $author or 'Author' }}">
            </a>
        </h2>
        <h3 title="" aria-hidden="true" style="margin: 0">

        </h3>
        <p class="links">
            <font aria-hidden="true">»</font>
            <a href="{{ url('/search') }}" aria-label="点击查看毕设">首页</a>
            {{--<a href="#" aria-label="点击查看博客">个人博客</a>--}}
            {{--<a href="#" aria-label="点击查看Github">Github</a>--}}
