...
<head>
    ...
    <title>氢搜索</title>
    {{--<link href="__PUBLIC__/static/index/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="__PUBLIC__/static/index/css/index.css" rel="stylesheet" type="text/css"/>--}}
    <link href="{{ elixir('css/style.css') }}" rel="stylesheet">
    <link href="{{ elixir('css/index.css') }}" rel="stylesheet">

    {{--{load href="__PUBLIC__/static/index/css/index.css" /}
    {load href="__PUBLIC__/static/index/css/style.css" /}--}}
</head>
<body>
        ...
        <div id="main">
            ...
            <div class="nav ue-clear">
                <ul class="searchList">
                    ...
                    <li class="searchItem" data-type="question">微信公众号文章</li>
...
<script type="text/javascript" src="{{ elixir('js/global.js') }}"></script>--}}

{{--{load href="__PUBLIC__/static/index/js/jquery.js" /}
{load href="__PUBLIC__/static/index/js/jquery.js" /}--}}
