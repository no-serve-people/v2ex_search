        ...
        <div class="col-sm-12">
            ...
            @if(Auth::user()->auth == 5)
                ...
                <div class="xe-widget xe-counter xe-counter-orange" data-count=".num" data-from="0"
                     data-to="{{ $cate_count }}" data-suffix="个" data-duration="2" data-easing="false">
                    <div class="xe-icon">
                ...
                <div class="xe-widget xe-counter xe-counter-blue" data-count=".num" data-from="0"
                     data-to="{{ $post_count }}" data-suffix="个" data-duration="2" data-easing="false">
                    <div class="xe-icon">
                ...
                <div class="xe-widget xe-counter xe-counter-purple" data-count=".num" data-from="0"
                     data-to="{{ $v2ex_count }}" data-suffix="个" data-duration="2" data-easing="false">
                    <div class="xe-icon">
            ...
            @endif
            <div class="xe-widget xe-counter xe-counter-pink" data-count=".num" data-from="1"
                 data-to="{{ $user_count }}" data-suffix="名" data-duration="3" data-easing="false">
                <div class="xe-icon">
